...
public:
  ...
  typedef enum {
    ...
    INT_MSK = 0x0F,
    INT_EN = 0x10,
    ACC_AM_THRESHOLD = 0x11,
    ACC_INT_SETTING = 0x12,
    ACC_HG_DURATION = 0x13,
    ACC_HG_THRESHOLD = 0x14,
    ACC_NM_THRESHOLD = 0x15,
    ACC_NM_SETTING = 0x16,
    GYRO_INT_SETTING = 0x17,
    GYRO_HR_X_SETTING = 0x18,
    GYRO_DURARTION_X = 0x19,
    GYRO_HR_Y_SETTING = 0x1A,
    GYRO_DURATION_Y = 0x1B,
    GYRO_HR_Z_SETTING = 0x1C,
    GYRO_DURATION_Z = 0x1D,
    GYRO_AM_THRESHOLD = 0x1E,
    GYRO_AM_SETTING = 0x1F
  } adafruit_bno055_reg_page1_t;
  ...
  } adafruit_bno055_gyrospeed_t;

  typedef enum {
    GYRO_RANGE_2000 = 0b000,
    GYRO_RANGE_1000 = 0b001,
    GYRO_RANGE_500  = 0b010,
    GYRO_RANGE_250  = 0b011,
    GYRO_RANGE_125  = 0b100
  } adafruit_bno055_gyrorange_t;
  ...
  void setGyroConfig(adafruit_bno055_gyrorange_t range, adafruit_bno055_gyrospeed_t bandwidth);
...
private:
  ...
  bool write8(adafruit_bno055_reg_page1_t, byte value);
